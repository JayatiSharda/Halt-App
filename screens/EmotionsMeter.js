...
export default function EmotionsMeter({route, navigation}){
...
        }
    ...
    const navigateToEmotions = () => {
        ...
        navigation.navigate("emotions" , {emotion : emotion})
    }
        ...
        <SafeAreaView style={{flex: 1}}>
            <ScrollView style={styles.container}>
                <View style={{flex: 1, padding: 20}}>
                    ...
                    <Emotions onSelectEmotionsMeter={selectEmotionsMeter} />
                    {emotionMeter !== "" ?
                    <TouchableOpacity style={styles.primaryButton} onPress={navigateToEmotions}>
